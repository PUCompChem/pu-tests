 ...
 * @author NK
 */
public class MyTest01NodePlugin extends Plugin {
    // The shared instance.
    private static MyTest01NodePlugin plugin;

    /**
     * The constructor.
     */
    public MyTest01NodePlugin() {
        super();
        plugin = this;
    }
     ...
     */
    public static MyTest01NodePlugin getDefault() {
        return plugin;
    }
